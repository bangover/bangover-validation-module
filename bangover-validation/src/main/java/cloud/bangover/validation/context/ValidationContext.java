...
public final class ValidationContext {
  ...
  private ValidationContext validate(ValidationGroup group, Validatable validatable,
      DerivationPolicy derivationPolicy) {
    return Optional.ofNullable(validatable).map(value -> {
      ValidationContext subContext = value
          .validate(new ValidationContext(group, derivationPolicy, new ValidationState()));
